                        ...
                        <div className={'flex flex-col h-screen'}>
                          ...
                          <div className={'px-4'}>
                            <div className={'flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'}>
                              <input type={'text'} value={(text)} onKeyDown={((event) => ((event.key === ('Enter')) && (sendMessage())))} onChange={((event) => (setText(event.target.value)))} className={'flex-1 outline-none text-slate-700'} placeholder={'Type a message...'} />
                              <label htmlFor={'image'}>
                              ...
                              <button type={'submit'} onClick={(sendMessage)} className={'bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full'}>
